...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.FormatDate = function (date) {
        return __WEBPACK_IMPORTED_MODULE_2_moment__(date).format('MMMM Do YYYY, H:mm:ss');
    };
    __decorate([
